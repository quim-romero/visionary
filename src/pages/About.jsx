    ...
    <>
      ...
      >
        ...
        <p className="text-lg text-neutral-700 dark:text-neutral-300 mb-4">
          ...
          forward-thinking creators around the world.
        </p>

        <p className="text-lg text-neutral-700 dark:text-neutral-300 mb-4">
          Our mission is to elevate digital artwork as a serious and collectible
          medium, creating a space for discovery, admiration and connection.
        </p>

        <p className="text-sm text-neutral-400 dark:text-neutral-500">
          This is a fictional project for portfolio purposes. All artwork and content is mock data.
        </p>
      </motion.main>
    </>
  )
